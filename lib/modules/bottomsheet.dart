                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            validator: (Text){
                              if( Text==null || Text.isEmpty){
                                return' enter your tast details ';
                          ...
                          InkWell(
                            onTap: (){
AppCubit.get(context).ChooseDate(context);
                            },
                            child: Container(
                              height: 40.h,
                              width: 120.w,
                              ...
                              child: Center(
                                child: Text(style: TextStyle(fontSize: 22.sp,color: Colors.white,fontWeight: FontWeight.bold),
                                    '${
